...
from hamcrest import assert_that, equal_to, has_item, has_property, raises, calling
...
class InstanceApiTest(TestCase):
    ...
    def test_shouldNotReturnOtherObjectsApprovalsForTheAuthorizedUser(self):
        ...
        workflow_object1 = TestModelObjectFactory()
        workflow_object2 = TestModelObjectFactory()
